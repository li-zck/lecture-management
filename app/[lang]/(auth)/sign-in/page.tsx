...
import { SignInFormData } from "@/lib/types/dto/api/request/auth";
...
export default function SignInPage() {
  ...
  const getIdentifierLabel = () => {
    if (loginMethod === "id") {
      return role === "student" ? s.studentId : s.lecturerId;
    }
    return s.username;
  };
  ...
  const getIdentifierPlaceholder = () => {
    if (loginMethod === "id") {
      return role === "student" ? s.enterStudentId : s.enterLecturerId;
    }
          ...
          <div className="relative z-10 max-w-md space-y-8">
            ...
            <div className="space-y-4 pt-8">
              ...
              <div className="flex items-start space-x-3 p-4 rounded-lg bg-background/10 backdrop-blur-sm transition-all duration-300 hover:bg-background/15 hover:translate-x-1">
                ...
                <div>
                  <h3 className="font-semibold text-lg">{s.collaboration}</h3>
                  <p className="text-primary-foreground/80 text-sm leading-relaxed">
                    {s.collaborationDesc}
                  </p>
                </div>
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="space-y-3 text-center">
              ...
              <p className="text-muted-foreground text-sm md:text-base">
                {role === "student" ? s.signInStudent : s.signInLecturer}
              </p>
            </div>
            ...
            <SignInForm
              ...
              schema={schema}
              fields={fields}
              onSubmitAction={(values: FieldValues) =>
                onSubmit(values as SignInFormData)
              }
            ...
            <div className="text-center">
              ...
              >
                {loginMethod === "id"
                  ? s.signInWithUsername
                  : role === "student"
                    ? s.signInWithStudentId
                    : s.signInWithLecturerId}
              </button>
            </div>
