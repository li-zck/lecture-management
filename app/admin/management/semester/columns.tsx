...
import { Semester, adminSemesterApi } from "@/lib/api/admin-semester";
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                        onClick={() => router.push(`/admin/management/semester/${semester.id}`)}
                    >
...
export const columns: ColumnDef<Semester>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => <div>{format(new Date(row.getValue("startDate")), "PPP")}</div>,
    },
    {
        accessorKey: "endDate",
        header: ({ column }) => (
