...
import { Department, adminDepartmentApi } from "@/lib/api/admin-department";
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                        onClick={() => router.push(`/admin/management/department/${department.id}`)}
                    >
...
export const columns: ColumnDef<Department>[] = [
    {
        ...
        cell: ({ row }) => <div className="w-[100px]">{row.getValue("departmentId")}</div>,
    },
    {
        accessorKey: "name",
        header: ({ column }) => (
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div>{row.original.head?.fullName || "N/A"}</div>
        ),
    },
    {
        id: "actions",
