...
/**
 * Course bulk create configuration
 */
export const courseBulkConfig: BulkCreateConfig = {
  entityName: "Course",
  ...
  fields: [
    ...
    },
    {
      ...
      type: "text",
      required: false,
      placeholder: "clxx1234567890",
      description: "UUID of the department",
    },
    {
      name: "recommendedSemester",
      label: "Recommended Semester/Level",
      type: "text",
      required: false,
  ...
  exampleData: [
    {
      ...
      description: "Introduction to single-variable calculus",
    },
    {
      name: "Physics I",
      credits: 4,
...
export function getBulkCreateConfig(
  entityType: "student" | "lecturer" | "department" | "course",
): BulkCreateConfig {
  switch (entityType) {
    case "student":
