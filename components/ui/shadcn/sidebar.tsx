...
function SidebarProvider({
	...
	// Internal state for open (desktop)
...
function Sidebar({
	...
	if (collapsible === "none") {
		return (
			<div
				...
				className={cn(
					"bg-sidebar text-sidebar-foreground fixed inset-y-0 left-0 z-10 flex h-svh w-[--sidebar-width] flex-col border-r",
					className,
				)}
				{...props}
			>
	...
	return (
		<div
			className="text-sidebar-foreground group peer hidden shrink-0 md:flex md:flex-col"
			data-state={state}
			data-collapsible={state === "collapsed" ? collapsible : ""}
			data-variant={variant}
			data-side={side}
		>
			{/* Gap on desktop - reserves space for fixed sidebar */}
			<div
				className={cn(
